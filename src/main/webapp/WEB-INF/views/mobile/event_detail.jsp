    	...
    	<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
			...
			<main class="mdl-layout__content">
				<div class="mdl-card__title mdl-color--darkblue mdl-color-text--white relative mdl-subheader nav-bg1 mdl-layout--fixed-drawer">
					<a href="<%= request.getContextPath() %>/event" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--icon">
						<i class="material-icons txt-light">arrow_back</i>
					</a>
					<h2 class="mdl-card__title-text uppercase-font font-18 txt-light">{{getEventByEventId.eventName}} </h2>
				</div>
				<br>
						...
						<div class="page-content">
							<section class="hero--main">
								<div class="owl-carousel owl-theme carousel--cards">
									<c:forEach var="eventimage" items='${eventimage}'>
									<div class="item content mdl-js-ripple-effect">
										<img class="img-responsive" src="${eventimage.image}" alt="image" />
