	...
	<div class="container">
		...
		<ul>
			<li class="col-md-3">
				...
				<div class="site-logo">
					<a href="index.html"><img src="<%=request.getContextPath()%>/resources/front/img/logo.png" alt="Side Logo" /><h1>Daily <span>News</span></h1><h3>The Daily News Source</h3></a>
				</div> --%> <!-- / .navbar-header -->
...
<footer id="ccr-footer">
	<div class="container">
	 	<div class="copyright" style="color:#333;">
	 		&copy; 2019, Copyrights <a href="http://astartechnologies.com">Astar Technologies</a> Theme. All Rights Reserved
	 	</div> <!-- /.copyright -->
