    	...
    	<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
			...
			<main class="mdl-layout__content">
				<div class="mdl-card__title mdl-color--darkblue mdl-color-text--white relative mdl-subheader nav-bg1 mdl-layout--fixed-drawer">
					...
					<h2 class="mdl-card__title-text uppercase-font font-18 txt-light">Events </h2>
				</div>
				<br>
				<div class="page-content">
					...
					<section class="categories-list">
							<div class="mdl-grid">
								<div ng-repeat="item in getEvents" class="mdl-card mdl-cell--3-col mdl-cell--12-col-tablet mdl-cell--12-col-phone mdl-shadow--2dp demo-card-wide">
									<a href="<%=request.getContextPath() %>/event_detail?eventid={{item.eventId}}"  class="mdl-card__title" style="background-image: url({{item.image}});text-decoration:none;">
										<h2 class="mdl-card__title-text uppercase-font font-16"> {{item.eventName}} </h2>
									</a>
