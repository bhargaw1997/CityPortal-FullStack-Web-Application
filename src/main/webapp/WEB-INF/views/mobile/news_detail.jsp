						...
						<div class="page-content">
							<section class="hero--main">
								<div class="owl-carousel owl-theme carousel--cards">
									<c:forEach var="newsimage" items='${newsimage}'>
									<div class="item content mdl-js-ripple-effect">
										<img class="img-responsive" src="${newsimage.image}" alt="image" />
							...
							<div class="mdl-grid">
								<div class="mdl-card mdl-cell--3-col mdl-cell--12-col-tablet mdl-cell--12-col-phone mdl-shadow--2dp demo-card-wide">
									<div class="mdl-card__supporting-text">
										<div class = "mdl-grid">
											<h2 class="mdl-card__title-text uppercase-font font-16" style="color:black;font-family:arial"> {{getNewsByNewsId.newsTitle}} </h2>
