    	...
    	<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
			...
			<main class="mdl-layout__content">
				<div class="mdl-card__title mdl-color--darkblue mdl-color-text--white relative mdl-subheader nav-bg1 mdl-layout--fixed-drawer">
					...
					<h2 class="mdl-card__title-text uppercase-font font-18 txt-light">News </h2>
				</div>
				<br>
				<div class="page-content">
					...
					<section class="categories-list">
							<div class="mdl-grid">
								<div ng-repeat="item in getNews" class="mdl-card mdl-cell--3-col mdl-cell--12-col-tablet mdl-cell--12-col-phone mdl-shadow--2dp demo-card-wide">
									<a href="<%= request.getContextPath() %>/news_detail?newsid={{item.newsId}}"  class="mdl-card__title" style="background-image: url({{item.image}});text-decoration:none;">
										<h2 class="mdl-card__title-text uppercase-font font-16"> {{item.newsTitle}} </h2>
									</a>
										...
										<div class = "mdl-grid">
											<div class = "mdl-cell mdl-cell--6-col mdl-cell--6-col-tablet mdl-cell--6-col-phone graybox">
												<div style="width: 100%;" class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
													<a href="<%=request.getContextPath() %>/news_detail?newsid={{item.newsId}}" style="text-decoration:none;"><div style="color:black;" ng-bind-html="item.newsDescription | cut:true:300:' ...' | to_trusted"></div></a>
												</div>
											</div>
										</div>
									</div>
									<div  class="mdl-card__actions mdl-card--border text-center">
										<a href="<%=request.getContextPath() %>/news_detail?newsid={{item.newsId}}"  style="margin: 0px 0px 0px 0px;" class="mdl-cell mdl-button mdl-button--raised mdl-button--colored mdl-js-button mdl-js-ripple-effect mdl-js-ripple-effect">Read More</a>
									</div>
								</div>
							</div>
						</section>
