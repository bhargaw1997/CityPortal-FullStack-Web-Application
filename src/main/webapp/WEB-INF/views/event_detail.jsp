...
<!-- Last Update Top Scrept End-->	
    ...
    <body ng-app="cityportal" ng-controller="eventCtrl" ng-init="getEventByEventId(<%= request.getParameter("eventid") %>)" ng-cloak>
	...
	<div class="container">
		...
		<section id="ccr-left-section" class="col-md-10">
			...
			<div class="current-page">
				<a href="<%=request.getContextPath() %>/"><i class="fa fa-home"></i> <i class="fa fa-angle-double-right"></i></a> <a href="<%=request.getContextPath() %>/event">Events<i class="fa fa-angle-double-right"></i></a>{{getEventByEventId.eventName}}
			</div> <!-- / .current-page -->

			<article id="ccr-article" >
				<h1><a href="#" >{{getEventByEventId.eventName}}</a></h1>
				...
				<section ng-show="getimagelist.length != 0" id="ccr-slide-main" class="carousel slide" data-ride="carousel">				
					...
					<div class="carousel-inner">
						<c:forEach var="eventimage" items='${eventimage}' varStatus="status">
						<c:if test="${status.index == 0}">
						<div class="active item">
							<div class="container slide-element">
								<img src="${eventimage.image}" alt="Main Image Slider">
							</div>
						</div>
						</c:if>
						<c:if test="${status.index != 0}">
				...
				<%-- <div class="container"> 
					  <div id="myCarousel" class="carousel slide" data-ride="carousel">
					    ...
					    <div class="carousel-inner">
							...
							<div class="item active">
								<img src="${eventimage.image}" alt="${eventimage.imageName}" width="100%" height="100%" style="margin: unset;">
							</div>
							</c:if>
							<c:if test="${status.index != 0}">
							<div class="item">
					    ...
					    <a class="left carousel-control" href="#myCarousel" data-slide="prev">
					      <span class="fa fa-chevron-left" style="margin-top: 270px;"></span>
					      <span class="sr-only">Previous</span>
					    </a>
					    <a class="right carousel-control" href="#myCarousel" data-slide="next">
					      <span class="fa fa-chevron-right" style="margin-top: 270px;"></span>
					...
					<div ng-bind-html="getEventByEventId.eventdescription | to_trusted"></div>
