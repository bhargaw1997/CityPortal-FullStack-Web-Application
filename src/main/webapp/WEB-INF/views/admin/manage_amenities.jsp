...
<html>
  <head>
    ...
    <script src="<%= request.getContextPath()%>/resources/admin/js/controller/amenities.js"></script>
    
    
  </head>
  <body ng-app="cityportal" ng-controller="amenitiesCtrl" ng-cloak class="skin-blue sidebar-mini">
  	<div class="wrapper">
      	...
      	<div class="content-wrapper">
        	...
        	<section class="content">
          		<div class="box box-success collapsed-box">
                	...
                	<!-- form start -->
                	<form role="form" ng-submit="addAmenity()">
                  		<div class="row"> 
                    		<div class="box-body">
                      			<div class="form-group">
                        			<div class="col-md-6">
                          				<label for="name">Name</label>
                          				<input type="text" class="form-control" id="amenitynameadd" ng-model="amenitynameadd" placeholder="Name">
                        			</div>
                      			</div>
                    		</div>
                  		</div>
              	...
              	<div class="box box-success">
                	...
                	<div class="box-body" style="display: block;">
                  		<div class="box">
                    		<div class="box-body table-responsive no-padding">
                      			<table id="example1" class="table table-bordered">
                        			...
                        			<tbody>
										<tr class="text-center" ng-if="getAmenities == ''">
											<td colspan="4"><span class="label label-default" style="font-size: 15px;">Sorry... No data found.</span></td>
										</tr>
										<tr ng-repeat="item in getAmenities" style="cursor:pointer;cursor:hand">
											<td ng-click="getAmenity(item.amenityId)" title="Edit Record" data-toggle="modal" data-target="#amenitieseditModal"></td>
											<td ng-click="getAmenity(item.amenityId)" title="Edit Record" data-toggle="modal" data-target="#amenitieseditModal">{{item.amenityName}}</td>
											<td title="Delete" class="text-center">
												<input type="checkbox" ng-model="item.selected" value="{{item.amenityId}}">
											</td>
										</tr>
									</tbody>
									<tfoot ng-if="getAmenities != ''">
										<tr>
											<td colspan="2">
                      			...
                      			<div class="box-footer">
									<div class="row">								
										...
										<div class="col-md-7 text-right">
											...
											{{currentPage+1}}
											<button type="submit" class="btn btn-primary" ng-disabled="getAmenities.length ==  0" ng-click="next()">
                  		...
                  		<div class="example-modal">
                        	<div id="amenitieseditModal" role="dialog" class="modal">
                           		<div class="modal-dialog">
                              		<div class="modal-content">
                                		...
                                		<form ng-submit="editAmenity(Amenityid)">
                                			<div class="modal-body">
                                  				<div class="input-group">
                                    				<div class="col-md-6">
                                      					<label for="name">Name</label>
                                      					<input type="text" class="form-control" id="amenityname" ng-model="amenityname" placeholder="Name">
                                    				</div>
                                  				</div>
                                			</div>
                        ...
                        <div id="deleteModal" class="modal fade">
							<div class="modal-dialog">
								<div class="modal-content">
									<div class="modal-header">
										<h4 class="modal-title"> <i class="fa fa-trash-o" aria-hidden="true"></i> Delete Amenity </h4>
										<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
									</div>
									<div class="modal-body">
										<p ng-if="d == 0">Please select at least one record to delete.</p>
										<p ng-if="d != 0 && amenity == 0">Are you sure you want to delete these Records?</p>
										<p class="text-warning" ng-if="d != 0 && amenity == 0"><small>This action cannot be undone.</small></p>
									</div>
									<div class="modal-footer">
										<input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
										<input type="submit" ng-if="d != 0 && amenity == 0" class="btn btn-danger" value="Delete" ng-click="deleteAmenity()">
									</div>
								</div>
							</div>
						</div> 		
 			...
 			<script>
				...
				document.getElementById("amenities").classList.add("active");
			</script>
