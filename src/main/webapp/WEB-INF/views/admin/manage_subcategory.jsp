...
<html lang="en">
	...
	<body ng-app="cityportal" ng-controller="subcategoryCtrl" ng-cloak class="skin-blue sidebar-mini">
		<div class="wrapper">
				...
				<section class="content">
							...
							<div class="row">
								...
								<div class="col-md-2">
									<div class="form-group">
										...
										<input type="text" id="subcategorycodeadd" name="subcategorycodeadd" ng-model="subcategorycodeadd" placeholder="Sub Category Code" maxlength="2" capitalize class="form-control">
									</div>
								</div>
								<div class="col-md-4">
									<div class="form-group">
						...
						<div class="box-footer">
							<div class="row">
								...
								<div class="col-md-4 text-right">
									<button type="submit" ng-click="addSubcategory()" ng-disabled="spin == 1" class="btn btn-success pull-right"><i class="fa fa-refresh fa-spin" ng-if="spin == 1"></i> Submit</button>
								</div>
							</div>			
						</div>
					</div>
					<div class="box box-success">
								...
								<table class="table table-bordered">
									...
									<tbody>
										...
										<tr ng-repeat="item in getSubcategories" style="cursor:pointer;cursor:hand">
											...
											<td ng-click="getSubcategory(item.subcategoryId)" title="Edit Record" data-toggle="modal" data-target="#editModal">{{item.description}}</td>
											<td ng-click="getSubcategory(item.subcategoryId)" title="Edit Record" data-toggle="modal" data-target="#editModal"><img src="{{item.image}}" width="60%" alt="Image" ng-if="item.image != ''"></td>
						...
						<div class="box-footer">
							<div class="row">								
								<div class="col-md-5">
									<div class="hint-text" style="float:left">Showing <b>{{startindex+1}}-{{getSubcategories.length+startindex}}</b> out of <b>{{allcounts.subcategoryCount}}</b> entries</div>
								</div>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="row">
							<div class="col-md-4">
								<label>Select Category<font color="red" size="3">*</font></label>
								<div class="input-group">
									<select id="categoryname" name="categoryname" ng-model="categoryname" ng-options="item.categoryId as item.categoryName for item in getCategories" class="form-control" autofocus>
							...
							<div class="col-md-5">
								<div class="form-group">
									<label>Sub Category Name<font color="red" size="3">*</font></label>
									<input type="text" id="subcategoryname" name="subcategoryname" ng-model="subcategoryname" placeholder="Sub Category Name" class="form-control">
								</div>									
							</div>
							<div class="col-md-3">
								<div class="form-group">
									<label>Sub Category Code<font color="red" size="3">*</font></label>
									<input type="text" id="subcategorycode" name="subcategorycode" ng-model="subcategorycode" placeholder="Sub Category Code" maxlength="2" capitalize class="form-control">
								</div>									
							</div>
						</div>
						<div class="row">
							...
							<div class="col-md-2 text-center">
								...
								<br ng-if="subcategoryimage != ''">
								<a ng-click="deleteImage()" class="btn btn-danger text-center" ng-if="subcategoryimage != ''" data-toggle="tooltip" title="Remove Image">
					...
					<div class="modal-footer">
						<div class="row">
							...
							<div class="col-md-3">
								<button type="submit" ng-click="editSubcategory(subcategoryid)" ng-disabled="spin == 1" class="btn btn-success pull-right"><i class="fa fa-refresh fa-spin" ng-if="spin == 1"></i> Save changes</button>	
							</div>
						</div>					
					</div>
				</div>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<p ng-if="d != 0 && subcategory == 0">Are you sure you want to delete these Records?</p>
						<p class="text-warning" ng-if="d != 0 && subcategory == 0"><small>This action cannot be undone.</small></p>
						<p ng-if="d != 0 && subcategory != 0">Please delete other dependent records before deleting parent record.</p>
					</div>
					<div class="modal-footer">
						<input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
						<input type="submit" ng-if="d != 0 && subcategory == 0" class="btn btn-danger" value="Delete" ng-click="deleteSubcategory()">
					</div>
				</div>
			</div>
		</div>
