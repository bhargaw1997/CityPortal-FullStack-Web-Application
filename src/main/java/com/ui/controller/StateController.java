...
public class StateController
{
	...
	public String addState(String statename, String statecode, int countryname, HttpServletRequest request, HttpSession session)
	{
		logger.info("Inside Add State Controller");
	...
	public String editState(int stateid, String statename, String statecode, int countryname, HttpServletRequest request, HttpSession session)
	{
		logger.info("Inside Edit State Controller");
	...
	{
		logger.info("Inside Delete State Controller...");
