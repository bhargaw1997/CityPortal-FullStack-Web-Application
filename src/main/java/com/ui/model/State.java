...
public class State {
	...
	public State(int stateId, String stateName, String stateCode, int countryId, String status, int createdBy,
			String createdDate, String ipAddress, String countryName) {
		super();
		this.stateId = stateId;
		this.stateName = stateName;
